...
values (UUID_TO_BIN('e8b46e74d60e11eaa79958fb845fce30'), '地球中国', '曹操', '11223354421',
        UUID_TO_BIN('432ab81f72694caba2ae6a4418779175'), 1),
       (UUID_TO_BIN('2418e70759fc4cd9b947bb43c5f5602c'), '福建省漳州市龙海市龙海市一条龙街', '中国龙', '15548162202',
        UUID_TO_BIN('a0ca9ba65d644d858e3886a4f428b447'),
        0),
       (UUID_TO_BIN('3698187a25d14cc7955d41bd1427dc2f'), '内蒙古自治区赤峰市元宝山区赤峰元宝人', '二宝', '12558128522',
        UUID_TO_BIN('a5b010ba20994224a4e0584bc0ddd8ad'),
        1),
       (UUID_TO_BIN('3fe8b0070f9749ad822cf8b0865c687e'), '吉林省吉林市龙潭区吉林小街道2', '小草2', '14452211002',
       ...
       (UUID_TO_BIN('9012cff375f549e7a154127df44605d7'), '黑龙江省哈尔滨市松北区松花江上', '庞龙', '18956234586',
        UUID_TO_BIN('a433b84c42134643901c3466f69dd7a8'),
        0),
       (UUID_TO_BIN('bc09c265c8004a41afca70309880b5af'), '浙江省温州市瓯海区浙江温州皮革厂', '表哥', '15548185222',
        UUID_TO_BIN('a433b84c42134643901c3466f69dd7a8'),
        1),
       (UUID_TO_BIN('e6362835e76443809f589804c5079168'), '湖北省武汉市洪山区武汉洪山区的扛把子', '扛把子', '14889165223',
        UUID_TO_BIN('a433b84c42134643901c3466f69dd7a8'),
        0);
